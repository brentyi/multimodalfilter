...
class PushKalmanFilter(
    torchfilter.filters.VirtualSensorExtendedKalmanFilter, PushTask.Filter
):
...
class PushVirtualSensorModel(torchfilter.base.VirtualSensorModel):
    def __init__(
        self,
        units: int = 64,
